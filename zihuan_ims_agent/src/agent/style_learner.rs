...
use crate::agent::language_style_store::{upsert_language_style, LanguageStyleScope};
use crate::agent::logging::QqChatTaskTrace;
use crate::agent::msg_send::{build_reply_result, send_planned_batches, QqChatServiceSendContext};
...
pub(crate) struct OwnedStyleLearningTaskContext {
    ...
    pub reply_batch_builder: Option<crate::agent::model::QqChatServiceReplyBatchBuilder>,
