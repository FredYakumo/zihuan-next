...
pub(crate) fn send_editable_tool_progress_notification(
    ...
    let event = match shared_rt.get(zihuan_core::graph::brain_tool_spec::QQ_AGENT_TOOL_FIXED_MESSAGE_EVENT_INPUT) {
    ...
    let adapter = match shared_rt.get(zihuan_core::graph::brain_tool_spec::QQ_AGENT_TOOL_FIXED_BOT_ADAPTER_INPUT) {
