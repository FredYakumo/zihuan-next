...
pub const MYSQL_TABLES: &[(&str, &[&str])] = &[
    ...
    (
        qq_chat_agent_ignore_rule::MYSQL_DDL,
        qq_chat_agent_ignore_rule::MYSQL_INDEXES,
    ),
...
pub const SQLITE_TABLES: &[(&str, &[&str])] = &[
    ...
    (
        qq_chat_agent_ignore_rule::SQLITE_DDL,
        qq_chat_agent_ignore_rule::SQLITE_INDEXES,
    ),
