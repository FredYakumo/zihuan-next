...
use crate::ims_bot_adapter::adapter::SharedBotAdapter;
use crate::ims_bot_adapter::models::event_model::{MessageEvent, MessageType, Sender};
use crate::ims_bot_adapter::models::message::{render_messages_readable, AtTargetMessage, Message, PlainTextMessage};
use crate::ims_bot_adapter::send_qq_message_batches::send_qq_message_batches;
use crate::ims_bot_adapter::ws_action::{response_message_id, response_success, ws_send_action};
use log::{info, warn};
use std::sync::Arc;
use tokio::task::block_in_place;
use crate::data_refs::RelationalDbConnection;
use crate::graph_engine::data_value::RedisConfig;
use crate::graph_engine::message_persistence::persist_message_event;
use crate::nlp::{PunctuationSegmenter, TextSegmenter};
