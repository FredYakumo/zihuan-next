...
use crate::ims_bot_adapter::runtime::send_qq_message_batches::{describe_message_segments, qq_messages_from_data_value};
use crate::ims_bot_adapter::runtime::ws_action::{json_i64, qq_message_list_to_send_json, response_message_id, response_success, ws_send_action};
use log::{info, warn};
...
impl Node for SendMessageNode {
    ...
    fn execute(&mut self, inputs: crate::graph::NodeInputFlow) -> Result<crate::graph::NodeOutputFlow> {
        ...
        let (action_name, target_id, params, target_label) = match sender {
            crate::ims_bot_adapter::runtime::models::sender_model::Sender::Friend(friend) => {
            ...
            crate::ims_bot_adapter::runtime::models::sender_model::Sender::Group(group) => {
