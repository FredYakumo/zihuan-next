...
use crate::ims_bot_adapter::runtime::message_helpers::get_bot_id;
use crate::ims_bot_adapter::runtime::models::MessageEvent;
use crate::ims_bot_adapter::runtime::ws_action::ws_send_action;
...
fn fallback_get_login_info(
    adapter: &SharedBotAdapter,
    s3_ref: &Option<Arc<S3Ref>>,
) -> Result<Option<crate::ims_bot_adapter::runtime::login_info::BotLoginInfo>> {
