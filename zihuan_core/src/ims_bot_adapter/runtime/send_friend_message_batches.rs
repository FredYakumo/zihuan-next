use crate::ims_bot_adapter::runtime::send_qq_message_batches::{execute_fixed_target_batch_send, TARGET_TYPE_FRIEND};
use crate::error::Result;
use crate::graph::{node_input, node_output, DataType, Node, Port};
