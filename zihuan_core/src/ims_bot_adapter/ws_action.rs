...
pub fn qq_message_list_to_json(messages: &[crate::ims_bot_adapter::models::message::Message]) -> serde_json::Value {
    serde_json::Value::Array(
        messages
            .iter()
            .map(|m| match m {
                crate::ims_bot_adapter::models::message::Message::Image(image) => serde_json::json!({
                    "type": "image",
                    "data": {
                        "file": image
                            .original_source()
