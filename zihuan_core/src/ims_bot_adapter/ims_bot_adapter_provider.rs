...
use crate::ims_bot_adapter::active_adapter_manager::ActiveAdapterManager;
...
impl Node for ImsBotAdapterProviderNode {
    ...
    fn execute(&mut self, _inputs: crate::graph_engine::NodeInputFlow) -> Result<crate::graph_engine::NodeOutputFlow> {
        ...
        let handle =
            crate::runtime::block_async(ActiveAdapterManager::shared().get_active_bot_adapter_handle(config_id))?;
