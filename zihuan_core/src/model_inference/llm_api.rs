use crate::model_inference::llm_message::convert::{
...
use crate::model_inference::system_config::{LlmApiStyle, ReasoningEffort, ThinkingType};
...
impl LLMAPI {
    ...
    fn log_usage(&self, request_context: &RequestContext, usage: &crate::llm::TokenUsage) {
