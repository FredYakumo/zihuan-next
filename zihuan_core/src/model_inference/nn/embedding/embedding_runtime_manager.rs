...
use crate::model_inference::system_config::{load_llm_refs, LlmRefConfig, ModelRefSpec};
...
pub fn close_runtime_embedding_instance(instance_id: &str) -> Result<bool> {
    crate::runtime::block_async(RuntimeEmbeddingModelManager::shared().close_instance(instance_id))
}
