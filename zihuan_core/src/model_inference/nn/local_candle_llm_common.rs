...
impl ParsedLocalResponse {
    pub fn into_message(self) -> LLMMessage {
        LLMMessage {
            role: crate::model_inference::llm::MessageRole::Assistant,
...
pub fn render_local_prompt(
    ...
    for message in messages {
        match message.role {
            crate::model_inference::llm::MessageRole::System => {
                sections.push(format!("System:\n{}", join_parts(&message.parts)));
            }
            crate::model_inference::llm::MessageRole::User => {
                sections.push(format!("User:\n{}", join_parts(&message.parts)));
            }
            crate::model_inference::llm::MessageRole::Assistant => {
            ...
            crate::model_inference::llm::MessageRole::Tool => {
                sections.push(format!(
