...
use crate::data_refs::{MySqlConfig, RelationalDbConnection};
use crate::error::{Error, Result};
use crate::graph_engine::{DataType, DataValue, Node, NodeConfigField, NodeConfigWidget, Port};

use crate::storage_handler::{RuntimeStorageConnectionManager, DEFAULT_MYSQL_ACQUIRE_TIMEOUT_SECS, DEFAULT_MYSQL_MAX_CONNECTIONS};
...
impl Node for MySqlNode {
    ...
    fn execute(&mut self, _inputs: crate::graph_engine::NodeInputFlow) -> Result<crate::graph_engine::NodeOutputFlow> {
        ...
        let config = crate::runtime::block_async(
