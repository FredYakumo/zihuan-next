use crate::storage_handler::load_connections;
use crate::storage_handler::resource_resolver::build_web_search_engine_ref;
use crate::error::{Error, Result};
use crate::graph_engine::{node_output, DataType, DataValue, Node, NodeConfigField, NodeConfigWidget, Port};
...
impl Node for TavilyProviderNode {
    ...
    fn description(&self) -> Option<&str> {
        Some("Tavily 搜索配置 - 从系统连接中选择并输出 WebSearchEngineRef")
    }
    ...
    fn execute(&mut self, _inputs: crate::graph_engine::NodeInputFlow) -> Result<crate::graph_engine::NodeOutputFlow> {
        ...
        crate::graph_engine::return_with_node_output![self;
            "tavily_ref" => DataValue::WebSearchEngineRef(tavily_ref),
        ]
    }
}
