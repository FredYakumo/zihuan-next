...
use crate::graph_engine::graph_io::refresh_port_types;
use crate::graph_engine::registry::{build_node_graph_from_definition, json_to_data_value, NODE_REGISTRY};
...
impl FunctionNode {
    pub fn new(id: impl Into<String>, name: impl Into<String>) -> Self {
        ...
        Self {
            id: id.into(),
            name: name.clone(),
            config: crate::graph_engine::function_graph::default_embedded_function_config(name),
        }
    }
    ...
    fn parse_config_input(&mut self, inputs: &crate::graph_engine::NodeConfigFlow) -> Result<()> {
    ...
    fn runtime_values_from_inputs(&self, inputs: &crate::graph_engine::NodeInputFlow) -> crate::graph_engine::RuntimeValueFlow {
        self.config
            .inputs
            .iter()
    ...
    fn collect_declared_outputs(
        &self,
        node_results: &HashMap<String, crate::graph_engine::NodeOutputFlow>,
...
impl Node for FunctionNode {
    ...
    fn execute(&mut self, inputs: crate::graph_engine::NodeInputFlow) -> Result<crate::graph_engine::NodeOutputFlow> {
        ...
        function_inputs_node.inline_values.insert(
            crate::graph_engine::function_graph::FUNCTION_SIGNATURE_PORT.to_string(),
        ...
        let outputs = crate::graph_engine::NodeOutputFlow::from(outputs);
...
pub fn inject_runtime_values_into_function_inputs_node(
    graph: &mut crate::graph_engine::NodeGraph,
    runtime_values: crate::graph_engine::RuntimeValueFlow,
) -> Result<()> {
