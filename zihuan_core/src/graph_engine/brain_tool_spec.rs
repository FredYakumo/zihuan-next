...
use crate::graph_engine::function_graph::{default_function_subgraph, FunctionPortDef, FUNCTION_OUTPUTS_NODE_ID};
use crate::graph_engine::graph_io::NodeGraphDefinition;
...
pub fn normalized_tool_outputs_for_owner(node_type: &str, tool: &BrainToolDefinition) -> Vec<FunctionPortDef> {
    if tool_subgraph_owner_uses_brain_outputs(node_type) {
        ...
        vec![FunctionPortDef {
            ...
            data_type: crate::graph_engine::DataType::String,
