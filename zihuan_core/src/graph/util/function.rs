...
impl FunctionNode {
    pub fn new(id: impl Into<String>, name: impl Into<String>) -> Self {
        ...
        Self {
            id: id.into(),
            name: name.clone(),
            config: crate::graph::function_graph::default_embedded_function_config(name),
        }
    }
    ...
    fn parse_config_input(&mut self, inputs: &crate::graph::NodeConfigFlow) -> Result<()> {
    ...
    fn collect_declared_outputs(
        &self,
        node_results: &HashMap<String, crate::graph::NodeOutputFlow>,
