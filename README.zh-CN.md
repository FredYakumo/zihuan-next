...
**一个 AI 智能体运行引擎，让你用节点图描述简单或事件驱动的 Agentic 工作流——只需几步即可运行 AI 智能体，并清晰地看到数据如何在流水线中流动。内置一批开箱即用的 AI 智能体模板。**
...
依赖：**Rust**（stable）、**Node.js 18+** 和 **pnpm**、**Redis**、**MySQL**。
...
# 编辑 config.yaml：Bot Server URL、LLM 端点、数据库凭据
