...
pub use zihuan_core::weaviate::{
    collection_config_for_schema, validate_collection_schema, WeaviateCollectionConfig,
    WeaviateCollectionSchema, WeaviateEnsureCollectionResult, WeaviateObjectInput,
    WeaviatePropertyConfig, WeaviateRef,
};
