                      ...
                      >
                        ...
                        >
                          ...
                          <div v-if="isCurrentCommandConfirmation(liveCall) && !liveCall.commandConfirmation?.decision" class="chat-command-confirmation chat-command-confirmation--inline">
                            ...
                            <button class="btn secondary" :disabled="liveCall.commandDecisionPending" @click="decideCommandConfirmation(liveCall, 'session')">本次对话允许类似指令</button>
                            <button class="btn danger" :disabled="liveCall.commandDecisionPending" @click="decideCommandConfirmation(liveCall, 'reject')">拒绝</button>
                          </div>
                        </div>
                      </div>
