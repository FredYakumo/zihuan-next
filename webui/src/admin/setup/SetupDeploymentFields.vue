...
import type { DetailedDeploymentConfig } from "../../api/client";
import SetupField from "./SetupField.vue";

const deployment = defineModel<DetailedDeploymentConfig>({ required: true });
</script>
