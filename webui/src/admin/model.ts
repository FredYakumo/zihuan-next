...
export const WORKSPACE_DEFAULT_TOOLS: DefaultToolOption[] = [
  ...
  { id: "find_files", label: "find_files", description: "按名称或 glob 查找文件和目录" },
  { id: "copy_file", label: "copy_file", description: "复制文件或目录" },
  { id: "move_file", label: "move_file", description: "移动或重命名文件或目录" },
  { id: "file_info", label: "file_info", description: "查看文件和目录元数据" },
  { id: "git_status", label: "git_status", description: "查看 Git 分支和工作区变更" },
