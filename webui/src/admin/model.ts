...
export type LlmApiStyle = "candle" | "open_ai_chat_completions_api" | "open_ai_responses_api";
...
export function defaultLlmConfig(): LlmServiceConfig {
  return {
    ...
    api_endpoint: "",
    api_key: "",
    api_style: "open_ai_chat_completions_api",
    stream: false,
...
export function llmFormFromConfig(config: LlmConfig): LlmFormState {
  ...
  return {
    ...
    llm: {
      ...
      api_style: (config.model.llm.api_style ?? "open_ai_chat_completions_api") as LlmApiStyle,
