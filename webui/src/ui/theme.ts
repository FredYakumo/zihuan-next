...
const DEFAULT_DARK: ThemeConfig = {
  ...
  css: {
    ...
    "--chat-user-bubble-bg": "#1e3a5f",
    "--chat-user-bubble-text": "#e6e6e6",
    "--chat-user-bubble-time": "#e6e6e6",
    "--border": "#222222",
    "--node-hover": "#1c1c1c",
    "--tab-inactive": "#252525",
    "--link": "#60a5fa",
...
const DEFAULT_LIGHT: ThemeConfig = {
  ...
  css: {
    ...
    "--chat-user-bubble-bg": "#dbeafe",
    "--chat-user-bubble-text": "#1a1a1a",
    "--chat-user-bubble-time": "#000000",
    "--border": "#e5e5e5",
    "--node-hover": "#f0f0f0",
    "--tab-inactive": "#e8e8e8",
    "--link": "#1d4ed8",
...
const COMPLEX_TYPES = new Set([
  "Json", "MessageEvent", "Sender", "LLMMessage", "QQMessage", "FunctionTools", "LLModel",
]);
