...
export const nodes = [
  {
    ...
    execute: async ({ inputs, sdk }) => ({ success: await sdk.storage.persistQQMessageVectors(sdk.resources.weaviate(inputs.weaviate_ref), sdk.resources.embeddingModel(inputs.embedding_model), inputs.qq_message_list, inputs), qq_message_list: inputs.qq_message_list }),
  },
  {
    ...
    execute: async ({ inputs, sdk }) => ({ success: await sdk.storage.persistImageVector(sdk.resources.weaviate(inputs.weaviate_ref), { ...inputs, embedding_model: inputs.embedding_model ? sdk.resources.embeddingModel(inputs.embedding_model) : undefined }), object_storage_path: inputs.object_storage_path }),
  },
  {
    ...
    execute: async ({ inputs, sdk }) => sdk.storage.searchImages(sdk.resources.weaviate(inputs.weaviate_ref), sdk.resources.embeddingModel(inputs.embedding_model), inputs.query, { limit: inputs.limit, max_distance: inputs.max_distance, target_vector: inputs.target_vector }),
  },
];
