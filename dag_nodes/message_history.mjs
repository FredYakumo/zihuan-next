...
export const nodes = [
  {
    ...
    execute: async ({ inputs, sdk }) => ({ success: await sdk.storage.persistQQMessageRdb(sdk.resources.rdb(inputs.rdb_ref), inputs.qq_message_list, inputs), qq_message_list: inputs.qq_message_list }),
  },
  {
    ...
    execute: async ({ inputs, sdk }) => sdk.storage.userHistory(inputs.mysql_ref, inputs.sender_id, inputs.group_id, inputs.limit),
  },
  {
    ...
    execute: async ({ inputs, sdk }) => sdk.storage.groupHistory(inputs.mysql_ref, inputs.group_id, inputs.limit),
  },
  {
    ...
    execute: async ({ inputs, sdk }) => sdk.storage.searchMessages(inputs.mysql_ref, inputs),
  },
];
