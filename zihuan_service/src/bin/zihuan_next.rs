// Re-export lib modules for binary use
use zihuan_service::api;
use zihuan_service::error;
use zihuan_service::init_registry;
use zihuan_service::log_forwarder;
use zihuan_service::setup_orchestrator;
use zihuan_service::system_config;
use zihuan_service::util;
