...
use zihuan_core::model_inference::system_config::{AgentConfig, AgentType};
...
pub struct ChatStreamRequest {
    ...
    #[serde(default)]
    pub thinking_type: Option<zihuan_core::model_inference::system_config::ThinkingType>,
    #[serde(default)]
    pub reasoning_effort: Option<zihuan_core::model_inference::system_config::ReasoningEffort>,
    #[serde(default)]
