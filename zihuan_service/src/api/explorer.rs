...
use zihuan_core::model_inference::system_config::{load_agents, AgentType};
...
use crate::agent::qq_chat::message_rate_limit_store::{
...
struct ServiceMemoryItem {
    #[serde(flatten)]
    record: zihuan_core::storage_handler::AgentMemoryRecord,
...
fn load_service_and_connections(
    ...
    zihuan_core::model_inference::system_config::AgentConfig,
    Vec<zihuan_core::storage_handler::ConnectionConfig>,
)> {
...
fn service_memory_config(
    agent: &zihuan_core::model_inference::system_config::AgentConfig,
