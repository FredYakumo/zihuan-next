...
fn parse_api_style(value: &str) -> zihuan_core::model_inference::system_config::LlmApiStyle {
    match value {
        "candle" | "candle_gguf" => zihuan_core::model_inference::system_config::LlmApiStyle::CandleGguf,
        "candle_hf" => zihuan_core::model_inference::system_config::LlmApiStyle::CandleHf,
        "open_ai_responses" => zihuan_core::model_inference::system_config::LlmApiStyle::OpenAiResponses,
        "open_ai_responses_message_compat" => zihuan_core::model_inference::system_config::LlmApiStyle::OpenAiResponsesMessageCompat,
        "open_ai_responses_image_url_object_compat" => {
            zihuan_core::model_inference::system_config::LlmApiStyle::OpenAiResponsesImageUrlObjectCompat
        }
        "open_ai_chat_completions_tencent_multimodal_compat" => {
            zihuan_core::model_inference::system_config::LlmApiStyle::OpenAiChatCompletionsTencentMultimodalCompat
        }
        _ => zihuan_core::model_inference::system_config::LlmApiStyle::OpenAiChatCompletions,
    }
}
