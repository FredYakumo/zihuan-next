...
/// Purpose: Verify that ReadFileTool supports base64 encoding with an
/// inclusive byte range, and that ListDirTool filters entries by a
...
/// Purpose: Verify that ExecCmdTool captures stdout while passing
