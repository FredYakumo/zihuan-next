...
impl Node for LLMInferNode {
    ...
    fn execute(&mut self, inputs: HashMap<String, DataValue>) -> Result<HashMap<String, DataValue>> {
        ...
        let model = match inputs.get("llm_model") {
            ...
            _ => return Err(zihuan_core::error::Error::ValidationError("Missing required input: llm_model".to_string())),
        };
        ...
        let messages: Vec<OpenAIMessage> = match inputs.get("messages") {
            ...
            _ => return Err(zihuan_core::error::Error::ValidationError("Missing required input: messages".to_string())),
        };
        ...
        outputs.insert("response".to_string(), DataValue::Vec(
